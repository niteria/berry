...
static be_define_const_map_slots(be_class_bytes_map) {
    ...
    { be_const_key(copy, 29), be_const_func(m_copy) },
    { be_const_key(_X2E_X2E, 31), be_const_func(m_connect) },
    ...
    { be_const_key(append, 2), be_const_func(m_connect) },
    { be_const_key(geti, 12), be_const_func(m_geti) },
    { be_const_key(_X21_X3D, -1), be_const_func(m_nequal) },
    { be_const_key(ismapped, 30), be_const_func(m_is_mapped) },
    { be_const_key(_change_buffer, -1), be_const_func(m_change_buffer) },
    { be_const_key(seti, 25), be_const_func(m_set) },
    { be_const_key(isreadonly, 28), be_const_func(m_is_readonly) },
    ...
    { be_const_key(_X2Esize, 23), be_const_var(2) },
    ...
    { be_const_key(get, 37), be_const_func(m_getu) },
    { be_const_key(tobool, 26), be_const_func(m_tobool) },
    ...
    { be_const_key(clear, 18), be_const_func(m_clear) },
